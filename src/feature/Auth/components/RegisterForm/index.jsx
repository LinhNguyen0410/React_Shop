...
function RegisterForm(props) {
  const schema = yup.object().shape({
    ...
    password: yup.string()
      ...
      .test('should uppercase for first character', 'Password must start with a uppercase character.',
        (value) => {
    ...
    retypePassword: yup.string().required('Please retype your password.').oneOf([yup.ref('password')], 'Password does not match.Please try again.')
  ...
  return (
    <div >
      ...
      <Avatar
        sx={{ display: "flex", margin: "0px auto", color: '#000' }}
      >
